...
contract QuadGovernanceOld is IQuadGovernanceOld, AccessControlUpgradeable, UUPSUpgradeable, QuadGovernanceStoreOld {
    ...
    function setPassportContractAddress(address _passportAddr)  external override {
        ...
        config.passport = IQuadPassportOld(_passportAddr);
    ...
    function passport() public view returns(IQuadPassportOld) {
