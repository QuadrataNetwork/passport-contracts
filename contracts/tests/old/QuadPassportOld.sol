...
contract QuadPassportOld is IQuadPassportOld, ERC1155Upgradeable, UUPSUpgradeable, QuadPassportStoreOld {
    ...
    function initialize(
        ...
        __ERC1155_init(_uri);
        governance = IQuadGovernanceOld(_governanceContract);
    ...
    function acceptGovernance() external override {
        ...
        governance = IQuadGovernanceOld(pendingGovernance);
