...
interface QuadPassportUpgradeInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "TestLog(string,bytes32)": EventFragment;
...
export type TestLogEvent = TypedEvent<
...
export class QuadPassportUpgrade extends BaseContract {
  ...
  interface: QuadPassportUpgradeInterface;
