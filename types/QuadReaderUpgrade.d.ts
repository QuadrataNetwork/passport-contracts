...
interface QuadReaderUpgradeInterface extends ethers.utils.Interface {
  functions: {
...
export class QuadReaderUpgrade extends BaseContract {
  ...
  interface: QuadReaderUpgradeInterface;
