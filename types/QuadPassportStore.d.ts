...
interface QuadPassportStoreInterface extends ethers.utils.Interface {
  functions: {
...
export class QuadPassportStore extends BaseContract {
  ...
  interface: QuadPassportStoreInterface;
