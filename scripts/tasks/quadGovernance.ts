...
task("setPreapproval", "npx hardhat setPreapproval --address <address> --status <boolean> --governance <address> --network <network_name>")
    .addParam("address", "sets the address")
    .addParam("status", "sets the status")
    .addParam("governance", "sets the governance address")
    .setAction(async function (taskArgs, hre) {
        const ethers = hre.ethers;
        const address = taskArgs.address;
        const status = taskArgs.status;
        const governanceAddress = taskArgs.governance;

        const governance = await recursiveRetry(ethers.getContractAt, "QuadGovernance", governanceAddress);
        await recursiveRetry(governance.setPreapprovals, [address], [status],
            {
                maxFeePerGas: ethers.utils.parseUnits("2000", "gwei"),
                maxPriorityFeePerGas: ethers.utils.parseUnits("2000", "gwei")
            });
        console.log("set preapproval for " + address + " to " + status + " on network " + hre.network.name);
    });
...
// usage for setting all attribute permissions for IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US
npx hardhat setAttributePermissions --issuers 0x0706a7CFC2d1B8EcFbF3dF103095Ac3047BeA431,0xd0c0256D625a74c0ACb7447Bd0940f23BBe33ff1,0x3097988FD29cD00f2C27B2b964F99Ac974d30A41,0x1135F3b9f2895Fb1B688B354Aea3C31114B49a38,0x8859c986F102924DBeC3767b67497b8d89Be2463 --attributes IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US --enabled true --governance 0x863db2c1A43441bbAB7f34740d0d62e21e678A4b --network goerli
npx hardhat setAttributePermissions --issuers 0x0706a7CFC2d1B8EcFbF3dF103095Ac3047BeA431,0xd0c0256D625a74c0ACb7447Bd0940f23BBe33ff1,0x3097988FD29cD00f2C27B2b964F99Ac974d30A41,0x1135F3b9f2895Fb1B688B354Aea3C31114B49a38,0x8859c986F102924DBeC3767b67497b8d89Be2463 --attributes IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US --enabled true --governance 0x863db2c1A43441bbAB7f34740d0d62e21e678A4b --network mumbai
npx hardhat setAttributePermissions --issuers 0x0706a7CFC2d1B8EcFbF3dF103095Ac3047BeA431,0xd0c0256D625a74c0ACb7447Bd0940f23BBe33ff1,0x3097988FD29cD00f2C27B2b964F99Ac974d30A41,0x1135F3b9f2895Fb1B688B354Aea3C31114B49a38,0x8859c986F102924DBeC3767b67497b8d89Be2463 --attributes IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US --enabled true --governance 0xC1fcC7790291FF3D9DC378bfA16047eC3002a83a --network avax_testnet
npx hardhat setAttributePermissions --issuers 0x0706a7CFC2d1B8EcFbF3dF103095Ac3047BeA431,0xd0c0256D625a74c0ACb7447Bd0940f23BBe33ff1,0x3097988FD29cD00f2C27B2b964F99Ac974d30A41,0x1135F3b9f2895Fb1B688B354Aea3C31114B49a38,0x8859c986F102924DBeC3767b67497b8d89Be2463 --attributes IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US --enabled true --governance 0xCF6bA3a3d18bA1e35A41db79B3dBF2F6023F6071 --network bsc_testnet
npx hardhat setAttributePermissions --issuers 0x0706a7CFC2d1B8EcFbF3dF103095Ac3047BeA431,0xd0c0256D625a74c0ACb7447Bd0940f23BBe33ff1,0x3097988FD29cD00f2C27B2b964F99Ac974d30A41,0x1135F3b9f2895Fb1B688B354Aea3C31114B49a38,0x8859c986F102924DBeC3767b67497b8d89Be2463 --attributes IS_ACCREDITITED_INVESTOR_US,IS_QUALIFIEDPURCHASER_US --enabled true --governance 0x2B212B47Faf2040cA4782e812048F5aE8ad5Fa2f --network celo_testnet
