...
export const PRICE_PER_ATTRIBUTES_FUJI = {
  [ATTRIBUTE_AML]: parseEther(".002"),
...
export const PRICE_PER_ATTRIBUTES = {
  ...
  [NETWORK_IDS.FUJI]: PRICE_PER_ATTRIBUTES_FUJI,
  [NETWORK_IDS.POLYGON]: PRICE_PER_ATTRIBUTES_MATIC,
  [NETWORK_IDS.MUMBAI]: PRICE_PER_ATTRIBUTES_MATIC,
  [NETWORK_IDS.CELO_TESTNET]: PRICE_PER_ATTRIBUTES_FUJI,
  [NETWORK_IDS.ARBITRUM_TESTNET]: PRICE_PER_ATTRIBUTES_FUJI,
  [NETWORK_IDS.FANTOM_TESTNET]: PRICE_PER_ATTRIBUTES_FUJI,
  [NETWORK_IDS.OPTIMISM_TESTNET]: PRICE_PER_ATTRIBUTES_FUJI,
...
export const PRICE_PER_BUSINESS_ATTRIBUTES = {
  ...
  [NETWORK_IDS.FUJI]: PRICE_PER_BUSINESS_ATTRIBUTES_FUJI,
  [NETWORK_IDS.CELO_TESTNET]: PRICE_PER_BUSINESS_ATTRIBUTES_FUJI,
  [NETWORK_IDS.ARBITRUM_TESTNET]: PRICE_PER_BUSINESS_ATTRIBUTES_FUJI,
  [NETWORK_IDS.FANTOM_TESTNET]: PRICE_PER_BUSINESS_ATTRIBUTES_FUJI,
  [NETWORK_IDS.OPTIMISM_TESTNET]: PRICE_PER_BUSINESS_ATTRIBUTES_FUJI,
...
export const reversePrint = {
  ...
  [ATTRIBUTE_CRED_PROTOCOL_SCORE]: "CRED_PROTOCOL_SCORE",
