...
describe("QuadReader.getAttributes", async () => {
  ...
  // describe("getAttributesTokenExcluding", async function () {
  ...
  //     );
  //   });
  //   it("fail - getAttributesTokenExcluding(AML) - wallet not found", async () => {
  //     const wallet = ethers.Wallet.createRandom();
  //     await expect(
  //       reader.getAttributesTokenExcluding(
  //         wallet.address,
  //         TOKEN_ID,
  //         ATTRIBUTE_AML,
  //         usdc.address,
  ...
  //   it("fail - getAttributesTokenExcluding from address(0)", async () => {
  //     await expect(
  //       reader.getAttributesTokenExcluding(
  //         ethers.constants.AddressZero,
  //         TOKEN_ID,
  ...
  //   it("fail - getAttributesTokenExcluding ineligible Token Id", async () => {
  //     const wrongTokenId = 2;
  //     await expect(
  //       reader.getAttributesTokenExcluding(
  //         minterA.address,
  ...
  //   it("fail - getAttributesTokenExcluding ineligible attribute (AML)", async () => {
  //     await governance
  //       .connect(admin)
  //       .setEligibleAttributeByDID(ATTRIBUTE_AML, false);
  //     await expect(
  ...
  //     );
  //   });
  //   it("fail - getAttributesTokenIncludingOnly(AML) - wallet not found", async () => {
  //     const wallet = ethers.Wallet.createRandom();
  //     await expect(
  ...
  //   it("fail - getAttributesIncludingOnly(DID) - wallet not found", async () => {
  //     const wallet = ethers.Wallet.createRandom();
  //     await expect(
  //       reader.getAttributesIncludingOnly(
  //         wallet.address,
  ...
  //     const calcPaymentToken = await reader.calculatePaymentToken(
  //       id("COUNTRY"),
  //       usdc.address,
  //       minterA.address
  //     );
  //     usdc.approve(reader.address, calcPaymentToken);
  //     const response = await reader.callStatic.getAttributesToken(
  //       minterA.address,
  //       1,
  //       id("COUNTRY"),
  //       usdc.address
  //     );
  //     await reader.getAttributesToken(
  //       minterA.address,
  //       1,
  //       id("COUNTRY"),
  //       usdc.address
  ...
  //       [issuer.address],
  //     ]);
  //     expect(initialBalanceInquisitor.sub(finalBalanceInquisitor).abs()).equals(
  //       calcPaymentToken
  //     );
  //     expect(initialBalancePassport.sub(finalBalancePassport).abs()).equals(
  //       calcPaymentToken
  //     );

  //     const issuerWithdrawAmount = await passport.callStatic.withdrawToken(
  //       issuerTreasury.address,
  //       usdc.address
  //     );
  //     const protocolWithdrawAmount = await passport.callStatic.withdrawToken(
  //       treasury.address,
  //       usdc.address
  //     );
  ...
  //     const response2 = await reader.callStatic.getAttributesToken(
  //       minterA.address,
  //       1,
  //       id("COUNTRY"),
  //       usdc.address
  ...
  //     const issuerWithdrawAmount2 = await passport.callStatic.withdrawToken(
  //       issuerTreasury.address,
  //       usdc.address
  //     );
  //     const protocolWithdrawAmount2 = await passport.callStatic.withdrawToken(
  //       treasury.address,
  //       usdc.address
  //     );

  //     expect(issuerWithdrawAmount2).equals(calcPaymentToken.div(2));
  //     expect(protocolWithdrawAmount2).equals(
  //       calcPaymentToken.div(2).add(calcPaymentToken)
  //     );
  //   });
  ...
  //     await governance
  //       .connect(admin)
  //       .setIssuerStatus(issuer.address, ISSUER_STATUS.ACTIVE);
  //     const initialBalanceInquisitor = await usdc.balanceOf(deployer.address);
  //     const initialBalancePassport = await usdc.balanceOf(passport.address);
  ...
  //     const calcPaymentToken2 = await reader.calculatePaymentToken(
  //       id("COUNTRY"),
  //       usdc.address,
  //       minterA.address
  //     );
  //     expect(issuerWithdrawAmount2).equals(calcPaymentToken.div(2));
  //     expect(protocolWithdrawAmount2).equals(
  //       calcPaymentToken.div(2).add(calcPaymentToken2)
  //     );
  //   });
  ...
  //     await governance
  //       .connect(admin)
  //       .setIssuerStatus(issuerB.address, ISSUER_STATUS.DEACTIVATED);
  ...
  //         usdc.address
  //       )
  //     ).to.be.revertedWith("TOKEN_PAYMENT_NOT_ALLOWED");
  //   });
  ...
  //     const initialBalanceInquisitor = await ethers.provider.getBalance(
  //       admin.address
  //     );
  ...
  //     const finalBalanceInquisitor = await ethers.provider.getBalance(
  //       admin.address
  //     );
  //     const finalBalancePassport = await ethers.provider.getBalance(
  //       passport.address
  //     );
  ...
  //     await passport.connect(minterA).burnPassport(1);
  //     await expect(
  //       reader.getAttributesFree(minterA.address, 1, id("AML"))
  //     ).to.be.revertedWith("PASSPORT_DOES_NOT_EXIST");
  //   });
  ...
  //     await governance
  //       .connect(admin)
  //       .setIssuerStatus(issuerB.address, ISSUER_STATUS.ACTIVE);

  //     const response2 = await reader.getAttributesFree(
  //       minterA.address,
  //       1,
  //       id("AML")
  //     );
  ...
  //     const calcPaymentETH = await reader.calculatePayment(
  //       id("COUNTRY"),
  //       minterA.address
  //     );
  //     const response = await reader.callStatic.getAttributes(
  //       minterA.address,
  //       1,
  //       id("COUNTRY"),
  //       { value: calcPaymentETH }
  //     );
  //     const tx = await reader.getAttributes(minterA.address, 1, id("COUNTRY"), {
  //       value: calcPaymentETH,
  //     });
  ...
  //       [issuer.address],
  //     ]);
  //     expect(initialBalanceInquisitor.sub(finalBalanceInquisitor)).equals(
  //       calcPaymentETH.add(gas)
  //     );
  //     expect(initialBalancePassport.sub(finalBalancePassport).abs()).equals(
  //       calcPaymentETH
  //     );

  //     const issuerWithdrawAmount = await passport.callStatic.withdraw(
  //       issuerTreasury.address
  //     );
  //     const protocolWithdrawAmount = await passport.callStatic.withdraw(
  //       treasury.address
  //     );
  ...
  //       { value: calcPaymentETH }
  //     );
  //     const tx = await reader.getAttributes(minterA.address, 1, id("DID"), {
  //       value: calcPaymentETH,
  //     });
  //     const metaData = await tx.wait();
  //     const gas = metaData.cumulativeGasUsed.mul(metaData.effectiveGasPrice);
  ...
  //       { value: calcPaymentETH }
  //     );
  //     const tx = await reader.getAttributes(minterA.address, 1, id("AML"), {
  //       value: calcPaymentETH,
  //     });
  //     const metaData = await tx.wait();
  //     const gas = metaData.cumulativeGasUsed.mul(metaData.effectiveGasPrice);
  ...
  //       .connect(admin)
  //       .setIssuerStatus(issuer.address, ISSUER_STATUS.DEACTIVATED);
  //     const response2 = await reader.callStatic.getAttributes(
  //       minterA.address,
  //       1,
  //       id("COUNTRY"),
  //       { value: calcPaymentETH }
  //     );
  //     await reader.getAttributes(minterA.address, 1, id("COUNTRY"), {
  //       value: calcPaymentETH,
  //     });
  //     expect(response2).to.eqls([[], [], []]);

  //     const issuerWithdrawAmount2 = await passport.callStatic.withdraw(
  //       issuerTreasury.address
  //     );
  //     const protocolWithdrawAmount2 = await passport.callStatic.withdraw(
  //       treasury.address
  //     );

  //     expect(issuerWithdrawAmount2).equals(calcPaymentETH.div(2));
  //     expect(protocolWithdrawAmount2).equals(
  //       calcPaymentETH.div(2).add(calcPaymentETH)
  //     );
  //   });
  ...
  //     await expect(
  //       reader.getAttributes(minterA.address, 1, id("COUNTRY"), {
  //         value: calcPaymentETH,
  //       })
  //     ).to.be.revertedWith("PASSPORT_DOES_NOT_EXIST");
  //   });
  ...
  //     const calcPaymentETH2 = await reader.calculatePayment(
  //       id("COUNTRY"),
  //       minterA.address
  //     );
  //     const response2 = await reader.callStatic.getAttributes(
  ...
  //     expect(issuerWithdrawAmount2).equals(calcPaymentETH.div(2));
  //     expect(protocolWithdrawAmount2).equals(
  //       calcPaymentETH.div(2).add(calcPaymentETH2)
  //     );
  //   });
  ...
  //     await expect(
  //       reader.getAttributes(wallet.address, TOKEN_ID, ATTRIBUTE_AML, {
  //         value: parseEther("0"),
  //       })
  //     ).to.revertedWith("PASSPORT_DOES_NOT_EXIST");
  //   });

  //   it("fail - getAttributes(DID) - wallet not found", async () => {
  //     const wallet = ethers.Wallet.createRandom();
  //     await expect(
  //       reader.getAttributes(wallet.address, TOKEN_ID, ATTRIBUTE_DID, {
  //         value: getDIDPrice,
  //       })
  //     ).to.revertedWith("PASSPORT_DOES_NOT_EXIST");
  //   });
  ...
  //   it("fail - insufficient eth amount", async () => {
  //     await expect(
  //       reader.getAttributes(minterA.address, TOKEN_ID, ATTRIBUTE_DID, {
  //         value: getDIDPrice.sub(1),
  //       })
  //     ).to.revertedWith("INSUFFICIENT_PAYMENT_AMOUNT");
  ...
  //     const wrongTokenId = 2;
  //     await expect(
  //       reader.getAttributes(minterA.address, wrongTokenId, ATTRIBUTE_DID, {
  //         value: getDIDPrice,
  //       })
  //     ).to.revertedWith("PASSPORT_TOKENID_INVALID");
  //   });
  ...
  //       .setEligibleAttributeByDID(ATTRIBUTE_AML, false);
  //     await expect(
  //       reader.getAttributes(minterA.address, TOKEN_ID, ATTRIBUTE_AML, {
  //         value: parseEther("0"),
  //       })
  //     ).to.revertedWith("ATTRIBUTE_NOT_ELIGIBLE");
  //   });
  ...
  //       .setEligibleAttribute(ATTRIBUTE_COUNTRY, false);
  //     await expect(
  //       reader.getAttributes(minterA.address, TOKEN_ID, ATTRIBUTE_COUNTRY, {
  //         value: parseEther("0"),
  //       })
  //     ).to.revertedWith("ATTRIBUTE_NOT_ELIGIBLE");
  //   });
