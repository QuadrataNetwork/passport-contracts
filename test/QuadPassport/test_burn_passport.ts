...
describe("QuadPassport", async () => {
  ...
  describe("burnPassportIssuer", async () => {
    ...
    it("success - mint 2 individual passports, delete issuerA, burnIssuerA, then assert only account level attributes remain on issuerB", async () => {
